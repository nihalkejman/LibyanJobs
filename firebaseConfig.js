...
import{where, query, collection, getDocs} from 'firebase/firestore'; // Import Firestore functions
...
export { db, doc, setDoc, auth, storage, where, query, collection, getDocs};